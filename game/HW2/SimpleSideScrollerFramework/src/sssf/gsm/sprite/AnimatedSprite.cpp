...
void AnimatedSprite::updateSprite()
{
	...
	//if (spriteType->getSpriteTypeID() == 0)
	//{
		
		//player->getBoundingVolume()->setCenterX(player2->GetPosition().x * 64);
		//player->getBoundingVolume()->setCenterY(player2->GetPosition().y * 64);
	//}
